...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        Permission::insert([
            ...
            ['name' => 'read-distributor', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'create-distributor', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'update-distributor', 'guard_name' => 'web', 'is_default' => 'Y'],
            ['name' => 'delete-distributor', 'guard_name' => 'web', 'is_default' => 'Y'],
