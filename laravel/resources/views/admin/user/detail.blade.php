                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            <li><a href="{{url('/administrator/users')}}" class="btn btn-light bg-white ajaxAction"><em class="icon ni ni-arrow-left"></em><span> Back</span></a></li>
                            @can('update-users')
                                <li><a href="{{ url('/') }}/administrator/users/{{ Hashids::encode($user->id) }}/edit" class="btn btn-primary ajaxAction"><em class="icon ni ni-edit"></em><span>Edit Profile</span></a></li>
                            @endcan
                        </ul>
                    </div>
                </div><!-- .toggle-wrap -->
