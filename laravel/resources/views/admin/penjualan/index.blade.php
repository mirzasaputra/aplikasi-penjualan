                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-sm-7">
                                        <div class="input-group">
                                            <input type="text" class="form-control" placeholder="Input Barcode" name="barcode" autocomplete="off" required autofocus>
                        ...
                        <tbody>
                            ...
                            <tr class="nk-tb-item">
                                ...
                                <td class="nk-tb-col nk-tb-col-tools">
                                    @can(['read-penjualan'])
                                        <a class="deleteItem text-danger nav-link" href="{{ url('/') }}/administrator/penjualan/{{ Hashids::encode($item->id) }}/deleteDetail"><em class="icon ni ni-trash ni-16"></em></a>
                                    @endcan
                                </td>
                            </tr><!-- .nk-tb-item -->
                            @endforeach
...
<div class="modal fade" id="modalPayment" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="{{url('/administrator/penjualan/payment')}}" method="post" id="formSubmitCustom">
                <div class="modal-header">
