...
<div class="nk-content-body">
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            ...
            <a href="{{url('/administrator/daftar-penjualan')}}" class="btn btn-light bg-white ajaxAction float-right"><em class="icon ni ni-arrow-left"></em><span> Back</span></a>
        ...
        <div class="card card-bordered card-preview">
            <div class="card-inner-group">
                <div class="card-inner p-4">
                    <a href="{{ url('/') }}/administrator/report/{{ $penjualan->invoice }}/struk" target="_blank" class="btn btn-light bg-white float-right"><em class="icon ni ni-printer-fill"></em><span> Cetak</span></a>
                    <table>
                        <tr>
