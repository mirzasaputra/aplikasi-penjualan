                                ...
                                <div class="nk-data data-list" style="margin-top:-5px">
                                    ...
                                    @foreach ($general as $generalSetting )
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit">
                                            ...
                                            <div class="data-col data-col-end"><a href="{{ url('/') }}/administrator/settings/{{ Hashids::encode($generalSetting->id) }}/edit" class="data-more ajaxAction"><em class="icon ni ni-forward-ios"></em></a></div>
                                        </div><!-- data-item -->
                                    @endforeach
                                </div><!-- data-list -->
                            </div>
