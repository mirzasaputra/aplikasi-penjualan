$('#cariBarang').submit(function(e){
    ...
    $.ajax({
        ...
        url: url + '/administrator/penjualan/findBarang',
        method: 'post',
...
$('input[name="tgl_awal"]').change(function(){
    ...
    $('#link').attr('href', url + '/administrator/report-penjualan/'+tgl_awal+'/'+tgl_akhir);
})
...
function tambahBarang(){
    ...
    if(id == ""){
        ...
        $.ajax({
            ...
            url: url + '/administrator/penjualan/tambahBarang',
            method: 'post',
