                ...
                <div class="toggle-wrap nk-block-tools-toggle">
                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            @can('create-barang')
                                <li><a href="/administrator/barang/create" class="btn btn-light bg-white ajaxAction"><em class="icon ni ni-plus"></em><span>Add New Menu</span></a></li>
                            @endcan
                        </ul>
                    </div>
                </div><!-- .toggle-wrap -->
                                                ...
                                                <div class="drodown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <ul class="link-list-opt no-bdr">
                                                            @can('update-barang') 
                                                                <li><a class="ajaxAction" href="/administrator/barang/{{ Hashids::encode($item->id).'/edit' }}"><em class="icon ni ni-edit"></em><span>Edit Barang</span></a></li>
                                                            @endcan
                                                            @can('delete-barang')
                                                                <li><a class="deleteItem" href="/administrator/barang/{{ Hashids::encode($item->id) }}/delete"><em class="icon ni ni-trash"></em><span>Delete Barang</span></a></li>
                                                            @endcan
                                                        </ul>
                                                    </div>
                                                </div>
