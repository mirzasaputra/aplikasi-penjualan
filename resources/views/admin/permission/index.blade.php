                    ...
                    <div class="toggle-expand-content" data-content="pageMenu">
                        <ul class="nk-block-tools g-3">
                            @can('create-permissions')
                                <li><a href="#myModal" data-toggle="modal" class="btn btn-light bg-white add"><em class="icon ni ni-plus"></em><span>Tambah Permission Baru</span></a></li>
                            @endcan
                        </ul>
                    </div>
                </div><!-- .toggle-wrap -->
                                                    ...
                                                    <div class="drodown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <ul class="link-list-opt no-bdr">
                                                                ...
                                                                @endcan
                                                                @can('delete-permissions')
                                                                    <li><a class="deleteItem" href="#"><em class="icon ni ni-trash"></em><span>Delete Permission</span></a></li>
                                                                @endcan
                                                            </ul>
                                                        </div>
                                                    </div>
